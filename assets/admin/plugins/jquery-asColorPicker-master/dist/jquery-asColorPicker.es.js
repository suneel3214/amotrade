...
var buttons = {
  defaults: {
    ...
    applyTemplate(namespace) {
      return `<a href="javascript:void(0)" alt="${this.options.applyText}" class="${namespace}-buttons-apply">${this.options.applyText}</a>`;
    },
    cancelTemplate(namespace) {
      return `<a href="javascript:void(0)" alt="${this.options.cancelText}" class="${namespace}-buttons-apply">${this.options.cancelText}</a>`;
    }
  },
...
var clear = {
  defaults: {
    template(namespace) {
      return `<a href="javascript:void(0)" class="${namespace}-clear"></a>`;
    }
  },
  ...
  defaults: {
    ...
    template() {
      ...
      if (this.options.switchable) {
        control += `<a href="javascript:void(0)" class="${namespace}-gradient-switch">${this.options.switchText}</a>`;
      }
      control += `<a href="javascript:void(0)" class="${namespace}-gradient-cancel">${this.options.cancelText}</a></div>`;
